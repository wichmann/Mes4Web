...
INSERT INTO MES.MACHINES (MACHINE_ID, NAME, NAME_PARA1, NAME_PARA2) VALUES (4, 'Ofen', 'Temp', 'Zeit');
...
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (2, 2, 1, 4, 65, 10);
...
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (5, 2, 2, 4, 45, 15);
INSERT INTO MES.PRODUCTION_STEPS (PRODUCTION_STEP_ID, STEP_NO, VARIANT_ID, MACHINE_ID, PARA1, PARA2) VALUES (6, 3, 2, 1, NULL, NULL);

INSERT INTO MES.ORDERS (ORDER_ID, PRODUCT_ID, COLOR_ID, VARIANT_ID, CUSTOMER_ID, ORDER_STATE, PART_ID) VALUES (4711, 1, 1, 1, 3, 0, NULL);
